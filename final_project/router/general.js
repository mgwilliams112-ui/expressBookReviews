...
public_users.get('/author/:author',function (req, res) {
    ...
    let booksByAuth = [];
    let requestedKeys = Object.keys(books).filter((book) => books[book].author == author);
    requestedKeys.forEach((key)=>{
        booksByAuth.push(books[key])
    })
...
public_users.get('/title/:title',function (req, res) {
    ...
    let booksByTitle = [];
    let requestedKeys = Object.keys(books).filter((book) => books[book].title == title);
    requestedKeys.forEach((key)=>{
